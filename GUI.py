...
def models_load():
    ...
    ycbcr_btn.configure(state='normal')
    luma_slider.configure(state='normal')
    cr_slider.configure(state='normal')
    cb_slider.configure(state='normal')
    # flag = 0
...
luma_slider = Scale(ycrcb_labelframe, from_=0, to=255, length=400, resolution=1, orient=VERTICAL, state='disable')
luma_slider.grid(row=0, column=0, pady=(10,0))

cr_slider = Scale(ycrcb_labelframe, from_=0, to=255, length=400, resolution=1, orient=VERTICAL, state='disable')
cr_slider.grid(row=0, column=1, pady=(10,0))

cb_slider = Scale(ycrcb_labelframe, from_=0, to=255, length=400, resolution=1, orient=VERTICAL, state='disable')
...
ycbcr_btn = Button(bottom_frame, width=30, height=3 ,textvariable=switch_var, command=lambda: ycbcr_switch(), bg="grey", state='disable')
